...
float Thermistor(int RawADC) {
  ...
  logR = log(Resistance); // Saving the Log(resistance) so not to calculate  it 4 times later
  Temp = 1 / (0.001129148 + (0.000234125 * logR) + (0.0000000876741 * logR * logR * logR));
